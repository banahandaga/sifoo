...
API_STAR_URL            = config('API_STAR_URL',        default='https://star.ums.ac.id/abubakar/') # set it to -> None if you don't use this
API_STAR_USERNAME       = config('API_STAR_USERNAME',   default=None)
API_STAR_PASSWORD       = config('API_STAR_PASSWORD',   default=None)
